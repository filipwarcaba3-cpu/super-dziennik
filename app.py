#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Super dziennik 4.7 - PostgreSQL-ready, SQLite fallback."""
...
if __name__=='__main__':
    init(); print(f'Super dziennik 4.7: http://{HOST}:{PORT}'); ThreadingHTTPServer((HOST,PORT),Handler).serve_forever()
