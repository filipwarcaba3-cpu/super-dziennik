#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Super dziennik 4.14 - blokowanie uczniów/nauczycieli, usuwanie uczniów przez Administratora IT i kolory ocen."""
...
def student_page(u,c,sid):
    ...
    manage_forms=(f"<div class='card col12'><h3>Zarządzanie uczniem</h3><div class=row>{("<a class='btn' href='/grades'>Dodaj ocenę</a>"%sid) if can_academic else ''}<a class='btn gray' href='/attendance?student_id={sid}'>Dodaj / popraw frekwencję</a></div></div>" if can_attendance else '')
