#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Super dziennik 4.10 - edycja komunikatów i odpowiedzi na wiadomości."""
...
if __name__=='__main__':
    init(); print(f'Super dziennik 4.10: http://{HOST}:{PORT}'); ThreadingHTTPServer((HOST,PORT),Handler).serve_forever()
